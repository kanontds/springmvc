...
<div data-options="region:'north',border:false" style="margin:0;padding:0;height:80px;">
    ...
    box-sizing: border-box;
        ...
        <table class="nav-header" cellspacing="0"><tr>
            ...
            <td><span style="font-size: 20px;color: white;padding-left:5px;">社区管理系统</span></td>
        </tr></table>
...
<script src="js/libs/require.js" data-main="apps/sqwork/app.js?v=1" bb="1468464346238"></script>
