...
define(function(){
    ...
    var comboupdate=function(option,record,local){
        require(['commonfuncs/popwin/win','text!manager/xt_combo.htm','manager/xt_combo'],function(win,htmfile,jsfile){
            win.render({
                title:'更新',
                width:524,
                height:200,
    ...
    var combodtupdate=function(option,record,local){
        ...
        require(['commonfuncs/popwin/win','text!manager/xt_combodt.htm','manager/xt_combodt'],function(win,htmfile,jsfile){
            win.render({
                title:'更新',
                width:524,
                height:200,
